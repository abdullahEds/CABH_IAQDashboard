                    ...
                    <div class="col-lg-12 text-center" style="margin-top: 20px;">
                        <div class="partner-description">
                            <p style="color: black;  text-align: left; margin-left: 90px;">
                                ...
                                While the data is free to use, it must be duly acknowledged and referanced. Please refer <br> 
                                suggested citation and disclaimers below.
                            </p>
                            <p style="color: black;  text-align: left; margin-left: 90px;"><b>Suggested Citation</b><br>
                            Information from Clean Air Better Health program #202 compiled on Breathin Dashboard by EDS for USAID and
                            CEEW. Please acknowledge this source while using information <br> from this portal. Select from MLA, APA and Harvard
                            styles for generating citation.</p>
                            <p style="color: black;  text-align: left; margin-left: 90px;"><b>Disclaimer</b><br>
                            This portal is made possible by the generous support of the American people through the United States Agency for
                            International Development USAID. It has been prepared under <br> the  Cleaner Air and Better Health CABH: project
                            Cooperative Agreement 72038621CA00010. The contents are the responsibility of the publishing agency and does
                            not necessarily <br> reflect the views of USAID or the United States Government, or the Council on Energy, Environment
                            and Water(CEEW).<br>
                            While this portal is an outcome of best efforts of experts, the User agrees to indemnify EDS and its partners against
                            any damages or liabilities arising from the use of information <br> published on this portal.</p>
                        </div>
                    </div>  
                </div>
