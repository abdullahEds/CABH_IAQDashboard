...
function getBoxplot(duration, typology, spaceType, sensorID, pollutants,indoorCondition, post_url, chart_id){
    ...
    console.log(pollutants.toUpperCase())
...
function updateBoxChart(chart_data,outdoordata, pollutants, chart_id){
    ...
    if (pollutants == "pm25"){
        label = "PM 2.5:";
        unit = "(µg/m[fontSize:6px; verticalAlign: super;]3[/]) ";
      }
      if (pollutants == "pm10"){
        label = "PM 10:";
        unit = "(µg/m[fontSize:6px; verticalAlign: super;]3[/])";
      ...
      if (pollutants == "co2"){
        label = "CO[fontSize:6px; verticalAlign: sub;]2[/]:";
        unit = "(ppm)";
      }
      if (pollutants == "voc"){
        label = "TVOC:";
    ...
    am5.ready(function() {
        ...
        var series = chart.series.push(
          am5xy.CandlestickSeries.new(root, {
            ...
            name: "Indoor "+pollutants1.toUpperCase(),
...
var series0 = chart.series.push(
  am5xy.LineSeries.new(root, {
    name: "Outdoor "+pollutants1.toUpperCase(),
  ...
  am5.ready(function() {
      ...
      function setResponsiveFontSize() {
          ...
          if (xAxis && yAxis && yAxis_line ) {
              ...
              yAxis_line.get("renderer").labels.template.setAll({
                fontSize: fontSize
            });
          }
