...
<div class="container">
    <div class="map-legend">
        <span class="indoor" style="width:18px; height:18px; padding:5px; border-radius: 3px; background-color: #ccc;"></span> Indoor
        <span class="outdoor" style="width:18px; height:18px; padding:5px; margin-left: 50px; border-radius: 3px; background-color: #ccc;"></span> Outdoor
    </div>
...
fetch("https://iaq-dashboard.edsglobal.com/api/dashboard/getPinData", requestOptions)
    ...
    .then(data => {
        ...
        $(document).on('click', '.marker', function() {
            ...
            var span_text = "<span class='bold'> Device ID: </span>" + deviceID +
