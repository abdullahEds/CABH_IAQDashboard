...
.offlinex {
    background-color: #f2b941; /* Example color for Outdoor */
    display: inline-block;
}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-body" >
                                        <h4 id="iaq-trend-title" class="dashboard_title text-center">Indoor Air Quality Trends - : <span >For Selected Monitor</span> </h4>
                                        <div class=" row text-left">
                                            ...
                                            <div class="col-lg-12" id="linechart1" name="linechart1" style="margin-left: -30px;" ></div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-body" >
                                            ...
                                            <!-- <h4 class="dashboard_title text-center">Indoor Air Quality Trend - Residential</h4> -->
                                            <h4 class="dashboard_title text-center">Indoor Air Quality Trends - Residential</h4>
                                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card-body" >
                                            <h4 class="dashboard_title text-center">Indoor Air Quality Trends - Office</h4>
...
mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2LW5pa3VuaiIsImEiOiJjbHMwYTNmdnowMDFxMmpyNTBteHoybTRwIn0.OEzenC6wBOTbqZXCUNoE7A';
    ...
    // First snippet
    {
        ...
        },
        {
            ...
            "occupancy": "1",
            "created_on": "2024-09-12 05:44:43",
            "updated_on": "2024-09-12 05:44:43"
        },
        {
            "deviceID": "1201240079",
        ...
        },
        {
            ...
            "occupancy": "3",
            "created_on": "2024-06-24 11:16:29",
            "updated_on": "2024-06-24 11:16:29"
        },
        {
            "deviceID": "1201240074",
        ...
        },
        {
            ...
            "occupancy": "4",
            "created_on": "2024-09-12 05:49:07",
            "updated_on": "2024-09-12 05:49:07"
        },
        {
            "deviceID": "1203240082",
            ...
            "total_build_up_area_sq_m": "110",
            "occupancy": "4",
            "created_on": "2024-06-24 11:55:19",
            "updated_on": "2024-06-24 11:55:19"
        },
        {
            "deviceID": "1202240029",
...
deviceData.forEach(device => {
    ...
    markerElement.style.backgroundColor = '#f2b941';
...
fetch("https://iaq-dashboard.edsglobal.com/api/dashboard/getPinData", requestOptions)
    ...
    .then(data => {
        ...
        $('#monitor_count').text(total_pin + " online monitors");
