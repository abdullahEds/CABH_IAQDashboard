...
function getData($deviceIDs, $startdt, $enddt){    
    ...
    substring_index( substring_index( group_concat(cast(abs(pm25) as decimal(10,2) ) order by abs(pm25) ASC separator ','),',',((0.50 * count(*))) ),',',-(1)) AS `median_pm25`,
 substring_index( substring_index( group_concat(cast(abs(pm10) as decimal(10,2) ) order by abs(pm10) ASC separator ','),',',((0.50 * count(*))) ),',',-(1)) AS `median_pm10`,
 substring_index( substring_index( group_concat(cast(abs(aqi) as decimal(10,2) ) order by abs(aqi) ASC separator ','),',',((0.50 * count(*))) ),',',-(1)) AS `median_aqi`,
 substring_index( substring_index( group_concat(cast(abs(co2) as decimal(10,2) ) order by abs(co2) ASC separator ','),',',((0.50 * count(*))) ),',',-(1)) AS `median_co2`,
 substring_index( substring_index( group_concat(cast(abs(voc) as decimal(10,2) ) order by abs(voc) ASC separator ','),',',((0.50 * count(*))) ),',',-(1)) AS `median_voc`,
 substring_index( substring_index( group_concat(cast(abs(temp) as decimal(10,2) ) order by abs(temp) ASC separator ','),',',((0.50 * count(*))) ),',',-(1)) AS `median_temp`,
 substring_index( substring_index( group_concat(cast(abs(humidity) as decimal(10,2) ) order by abs(humidity) ASC separator ','),',',((0.50 * count(*))) ),',',-(1)) AS `median_hum`
