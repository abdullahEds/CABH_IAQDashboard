                    ...
                    <div class="card-body" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <!-- Indoor context-->
                                <div class="row text-center " style="margin-top:15px; margin-bottom:10px; display:block"> 
                                    <h4>Indoor Condition:</h4>
                                    <button type="button" class="btn" id="btnWTemp_R_box" name="btnWTemp_R_box" >with Temp</button>
                                    <button type="button" class="btn" id="btnWRH_R_box" name="btnWRH_R_box" >with RH</button><br>
                    ...
                    <div class="card-body" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="row text-center " style="margin-top:15px; margin-bottom:10px; display:block"> 
                                    <h4>Indoor Condition:</h4>
                                    <button type="button" class="btn" id="btnWTemp_O_box" name="btnWTemp_O_box" >with Temp</button>
                                    <button type="button" class="btn" id="btnWRH_O_box" name="btnWRH_O_box" >with RH</button><br>
                                    <span class="note"><b>*Note: </b>With Temperature & RH chart will show only indoor data</span>
...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2jlT6C_to6X1mMvR9yRWeRvpIgTXgddM"></script>
    ...
    <script>
        ...
        center: [77.2, 28.53], // starting position [lng, lat] [77.2, 28.58]
        scrollZoom: true, // Disable scroll zoom
        dragPan: true, // Disable drag pan
        zoom: 10.6 // starting zoom //10
