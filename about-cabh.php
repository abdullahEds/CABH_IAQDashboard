        ...
        <div class="animated fadeIn">
            <div class="row justify-content-center"> <!-- Centering the content -->
                ...
                <div class="row partners-section">
                    ...
                    <h4 class="heading-about" style="font-weight: 600;">DONOR
                ...
                <div class="row partners-section">
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="partner-description" style="margin-top: 20px; text-align: justify;">
                            <p style="color: black; ">Environmental Design Solutions has a wide range of experience in the design, development, and implementation of large-scale programmes both in terms of project investments as well as bundled initiatives for energy efficiency and climate change measures. EDS focuses on reducing exposure through indoor air quality (IAQ) solutions.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 ">
                        <img class="partner-logo smaller" src="../images/asar.png" alt="ASAR Logo" style="width: 110px;">
                        <div class="partner-description" style="margin-top: 30px;text-align: justify; ">
                            <p style="color: black;">Asar Social Impact Advisors created the National Clean Air Collective in 2017 to get organisations, individuals, and groups working on air pollution to collaborate, complement each other's work, and to align on strategy. Asar leads on empowering communities through outreach and awareness initiatives.
                            </p>
                        </div>
                    </div>  
                    <div class="col-lg-4 col-md-12">
                        <img class="partner-logo" src="../images/vitals.png" alt="Vital Logo" style="width: 140px;">
                        <div class="partner-description">
                            <p style="color: black; text-align: justify;">Vital Strategies has programmes spanning 70 countries, and has worked with the government of India – the Ministry of Health and Family Welfare, and the Ministry of Environment, Forest and Climate Change, with local advocates for clean air, and with clinicians to promote clean air and health benefits of scaling clean household energy. Vital Strategies focuses on minimising exposure and health impact from air pollution through health data collection and engagement with the health sector.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <img class="partner-logo smaller" src="../images/eldf2.png" alt="ELDF Logo" style="width: 80px;">
                        <div class="partner-description">
                            <p style="color: black; text-align: justify;">Enviro-Legal Defence Firm is India’s first environmental law firm, and has dealt with multiple landmark environmental cases that have shaped the course of air quality management across India. ELDF has experience on legal and policy dimensions of air pollution including judicial precedents and leads the CABH project in identifying regulatory reforms, developing a comprehensive legal structure to support pollution control boards.</p>
                        </div>
                    </div>
                </div>
